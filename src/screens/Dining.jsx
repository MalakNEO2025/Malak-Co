...
const { Button, Badge, Input, Chip, SummaryCard } = window.NEOLIFEDesignSystem_08f245;
...
export function Dining({ go, cart, addItem, removeItem, openItem }) {
...
export function MenuDetail({ go, id, cart, addItem, removeItem }) {
...
export function Cart({ go, cart, addItem, removeItem, guest }) {
...
export function OrderConfirmed({ go, guest, clearCart }) {
