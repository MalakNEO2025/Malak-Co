...
export function TweaksPanel({ title = 'Tweaks', children }) {
  ...
  React.useEffect(() => {
    ...
    // Ctrl+. toggles the panel when running standalone
    const onKey = (e) => {
  ...
  if (!options || !options.length) {
    return (
      <div className="twk-row twk-row-h">
        ...
        <input type="color" style={{ width: 56, height: 22, border: '.5px solid rgba(0,0,0,.1)', borderRadius: 6, padding: 0, cursor: 'default', background: 'transparent', flexShrink: 0 }}
